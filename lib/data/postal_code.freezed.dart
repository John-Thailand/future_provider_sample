...
mixin _$PostalCodeData {
  ...
  PostalCodeAdress get ja => throw _privateConstructorUsedError;
  PostalCodeAdress get en => throw _privateConstructorUsedError;
...
abstract class $PostalCodeDataCopyWith<$Res> {
  ...
  $Res call({String prefcode, PostalCodeAdress ja, PostalCodeAdress en});

  $PostalCodeAdressCopyWith<$Res> get ja;
  $PostalCodeAdressCopyWith<$Res> get en;
}
...
class _$PostalCodeDataCopyWithImpl<$Res>
  ...
  @override
  $PostalCodeAdressCopyWith<$Res> get ja {
    return $PostalCodeAdressCopyWith<$Res>(_value.ja, (value) {
  ...
  @override
  $PostalCodeAdressCopyWith<$Res> get en {
    return $PostalCodeAdressCopyWith<$Res>(_value.en, (value) {
...
class _$_PostalCodeData
  ...
  @override
  final PostalCodeAdress ja;
  @override
  final PostalCodeAdress en;
...
abstract class _PostalCodeData implements PostalCodeData {
  const factory _PostalCodeData(
      ...
      required final PostalCodeAdress ja,
      required final PostalCodeAdress en}) = _$_PostalCodeData;
...
PostalCodeAdress _$PostalCodeAdressFromJson(Map<String, dynamic> json) {
  return _PostalCodeAdress.fromJson(json);
}

/// @nodoc
mixin _$PostalCodeAdress {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $PostalCodeAdressCopyWith<PostalCodeAdress> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PostalCodeAdressCopyWith<$Res> {
  factory $PostalCodeAdressCopyWith(
          PostalCodeAdress value, $Res Function(PostalCodeAdress) then) =
      _$PostalCodeAdressCopyWithImpl<$Res>;
  $Res call(
      {String prefecture,
      String address1,
      String address2,
...
/// @nodoc
class _$PostalCodeAdressCopyWithImpl<$Res>
    implements $PostalCodeAdressCopyWith<$Res> {
  _$PostalCodeAdressCopyWithImpl(this._value, this._then);

  final PostalCodeAdress _value;
  // ignore: unused_field
  final $Res Function(PostalCodeAdress) _then;
...
/// @nodoc
abstract class _$$_PostalCodeAdressCopyWith<$Res>
    implements $PostalCodeAdressCopyWith<$Res> {
  factory _$$_PostalCodeAdressCopyWith(
          _$_PostalCodeAdress value, $Res Function(_$_PostalCodeAdress) then) =
      __$$_PostalCodeAdressCopyWithImpl<$Res>;
  @override
  $Res call(
      {String prefecture,
      String address1,
...
/// @nodoc
class __$$_PostalCodeAdressCopyWithImpl<$Res>
    extends _$PostalCodeAdressCopyWithImpl<$Res>
    implements _$$_PostalCodeAdressCopyWith<$Res> {
  __$$_PostalCodeAdressCopyWithImpl(
      _$_PostalCodeAdress _value, $Res Function(_$_PostalCodeAdress) _then)
      : super(_value, (v) => _then(v as _$_PostalCodeAdress));

  @override
  _$_PostalCodeAdress get _value => super._value as _$_PostalCodeAdress;
  ...
  $Res call({
    ...
    return _then(_$_PostalCodeAdress(
      prefecture: prefecture == freezed
          ? _value.prefecture
          : prefecture // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_PostalCodeAdress
    with DiagnosticableTreeMixin
    implements _PostalCodeAdress {
  const _$_PostalCodeAdress(
  ...
  factory _$_PostalCodeAdress.fromJson(Map<String, dynamic> json) =>
      _$$_PostalCodeAdressFromJson(json);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PostalCodeAdress(prefecture: $prefecture, address1: $address1, address2: $address2, address3: $address3, address4: $address4)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'PostalCodeAdress'))
  ...
  @JsonKey(ignore: true)
  @override
  _$$_PostalCodeAdressCopyWith<_$_PostalCodeAdress> get copyWith =>
      __$$_PostalCodeAdressCopyWithImpl<_$_PostalCodeAdress>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_PostalCodeAdressToJson(this);
  }
}

abstract class _PostalCodeAdress implements PostalCodeAdress {
  const factory _PostalCodeAdress(
      ...
      required final String address4}) = _$_PostalCodeAdress;

  factory _PostalCodeAdress.fromJson(Map<String, dynamic> json) =
      _$_PostalCodeAdress.fromJson;
